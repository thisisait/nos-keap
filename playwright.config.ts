...
export default defineConfig({
  ...
  webServer: {
    ...
    command: `rm -rf e2e/.data e2e/.fsroot e2e/.userfiles && PORT=${PORT} KEAP_DATA_DIR=e2e/.data KEAP_FS_ROOTS=e2e=e2e/.fsroot KEAP_USER_FILES_DIR=e2e/.userfiles KEAP_FS_SHARED_UIDS=nos-docs KEAP_FS_SYNC_INTERVAL_S=0 KEAP_FS_WATCH_REARM_S=1 KEAP_AGENT_TOKEN_RO=e2e-ro KEAP_AGENT_TOKEN_RW=e2e-rw node dist-server/index.js`,
    port: PORT,
